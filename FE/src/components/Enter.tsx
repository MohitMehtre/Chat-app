  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f5f0e8] px-4 overflow-hidden relative">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        {/* Top Left: Sun Burst */}
        <svg className="absolute -top-16 -left-16 w-64 h-64 text-black/5 animate-[spin_12s_linear_infinite]" viewBox="0 0 100 100" fill="currentColor">
        ...
        <svg className="absolute -top-20 -right-20 w-80 h-80 text-black/[0.04]" viewBox="0 0 200 200" fill="currentColor">
          <path d="M44.7,-76.4C58.9,-69.2,71.8,-59.1,81.6,-46.6C91.4,-34.1,98.1,-19.2,95.8,-4.9C93.5,9.3,82.2,22.9,71,34.3C59.8,45.7,48.7,54.9,36.5,63.2C24.3,71.5,11,78.9,-1.2,80.9C-13.4,82.9,-27.8,79.5,-40.4,71.4C-53,63.3,-63.8,50.5,-71.8,36.3C-79.8,22.1,-85,6.5,-82.1,-7.8C-79.2,-22.1,-68.2,-35.1,-56.3,-45.1C-44.4,-55.1,-31.6,-62.1,-18.7,-65.4C-5.8,-68.7,7.2,-68.3,20.2,-67.9" transform="translate(100 100)" />
        </svg>

        {/* Middle Right: Plus Signs */}
        <div className="absolute top-1/3 right-12 flex flex-col gap-8">
          <div className="text-6xl font-black text-black/5 animate-pulse" style={{ animationDuration: '3s' }}>+</div>
          <div className="text-4xl font-black text-black/5 animate-bounce ml-8" style={{ animationDuration: '4s' }}>+</div>
        </div>

        {/* Middle Left: Static Squiggle */}
        <svg className="absolute top-1/3 left-8 w-16 h-48 text-black/5" viewBox="0 0 50 200" fill="none" stroke="currentColor" strokeWidth="6" strokeLinecap="round">
        ...
        {/* Rotating Triangles */}
        <svg className="absolute top-1/4 left-1/4 w-16 h-16 text-black/5 animate-[spin_8s_linear_infinite]" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 2L2 22H22L12 2Z" />
        </svg>
        <svg className="absolute bottom-1/4 right-1/3 w-20 h-20 text-black/5 animate-[spin_12s_reverse_linear_infinite]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        {/* Top Center: Hashtag */}
        <div className="absolute top-8 left-1/2 -ml-64 text-8xl font-black text-black/[0.02] -rotate-12 select-none">#</div>
      ...
      {isWarmingUp && (
        <div className="fixed inset-0 bg-[#f5f0e8]/90 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="text-center">
            <div className="inline-block border-4 border-black px-8 py-6 bg-white" style={{ boxShadow: '6px 6px 0 #000' }}>
        ...
        >
          <div className="grid md:grid-cols-5">
            ...
            <div className="md:col-span-2 bg-yellow-300 p-8 border-b-4 md:border-b-0 md:border-r-4 border-black flex flex-col justify-between relative overflow-hidden">
              <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(black 1px, transparent 1px)', backgroundSize: '8px 8px' }} />
            ...
            <div className="md:col-span-3 p-8 md:p-10 bg-white">
              ...
              >
                ...
                <div className="space-y-2">
                  <label className="block text-xs font-bold uppercase tracking-wider">
                    Password <span className="text-black/30 normal-case font-normal">(optional)</span>
                  </label>
                  <input
                    type="password"
                    placeholder="••••••"
